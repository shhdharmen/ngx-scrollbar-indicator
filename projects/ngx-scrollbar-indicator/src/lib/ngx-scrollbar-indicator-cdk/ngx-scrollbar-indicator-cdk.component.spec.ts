...
@Component({
  template: `<ngx-scrollbar-indicator-cdk #indicatorRef [options]="options" class="container">
...
describe('NgxScrollbarIndicatorCdkComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [
        NgxScrollbarIndicatorCdkComponent, ScrollbarIndicatorItemDirective, TestNgxScrollbarIndicatorCdkComponent
      ]
    }).compileComponents();
  }));

  beforeEach(() => {
    hostFixture = TestBed.createComponent(TestNgxScrollbarIndicatorCdkComponent);
